<template>
    <div id="registration">
      ...
      <hr>
      <label class="additional-text">Información requerida para del auto a dejar en garantía</label>
      <b-row>
        <b-col lg="6">
          <b-form-group
            id="fieldset-model"
            ...
            label-for="model"
            class="mt-3">
            <b-form-input id="model" v-model="model" type="text" placeholder="Introduzca el modelo de su auto"></b-form-input>
          </b-form-group>
        </b-col>
        <b-col lg="6">
          <b-form-group
            ...
            label-for="price"
            class="mt-3">
            <b-form-input id="price" v-model="input_price" type="text" placeholder="Introduzca el precio factura de su auto" @blur="isPriceActive = false" @focus="isPriceActive = true"></b-form-input>
          </b-form-group>
        </b-col>
...
export default {
    ...
    input_price: {
      get () {
        if (this.price === '0.00' || this.price === '') {
          return ''
        } else if (this.isPriceActive) {
          return this.price.toString()
        } else {
          return parseFloat(this.price).toFixed(2).replace(/(\d)(?=(\d{3})+(?:\.\d+)?$)/g, '$1,')
        }
      },
      set (value) {
  ...
  methods: {
    ...
    formSubmitted() {
      ...
      axios
        .post('http://localhost:8000/car', obj)
        .then(response => {
