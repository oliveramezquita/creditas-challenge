<template>
    <div id="registration">
      ...
      <hr>
      <label class="additional-text">Información requerida para la casa a dejar en garantía</label>
      <b-row>
        <b-col lg="6">
            <b-form-group
                id="fieldset-value"
                ...
                label-for="value"
                class="mt-3">
                <b-form-input id="value" v-model="input_value" type="text" placeholder="Introduzca el valor del domicilio" @blur="isValueActive = false" @focus="isValueActive = true"></b-form-input>
            </b-form-group>
        </b-col>
      </b-row>
      <b-row>
        <b-col lg="8">
            <b-form-group
                id="fieldset-ug_address"
                label="Domicilio"
                label-for="ug_address"
                class="mt-3">
                <b-form-input id="ug_address" v-model="ug_address" type="text" placeholder="Introduzca el domicilio"></b-form-input>
            </b-form-group>
        </b-col>
        <b-col lg="4">
            <b-form-group
                id="fieldset-ug_zipcode"
                label="Código Postal"
                label-for="ug_zipcode"
                class="mt-3">
                <b-form-input id="ug_zipcode" v-model="ug_zipcode" type="text" placeholder="Introduzca el código postal" v-on:keypress="isLetterOrNumber($event)"></b-form-input>
            </b-form-group>
        </b-col>
        <b-col lg="6">
            <b-form-group
                ...
                label-for="ug_city"
                class="mt-3">
                <b-form-input id="ug_city" v-model="ug_city" type="text" placeholder="Introduzca la ciudad"></b-form-input>
            </b-form-group>
        </b-col>
        <b-col lg="6">
            <b-form-group
                id="fieldset-ug_state"
                label="Estado"
                label-for="ug_state"
                class="mt-3">
                <v-select v-model="local_ugstate" :options="states" name="ug_state" label="name" />
            </b-form-group>
        </b-col>
...
export default {
  ...
  computed: {
    ...
    local_ugstate: {
        get() {
            return this.ug_state
        },
        set(s) {
            this.ug_state = s.name
        }
    },
    input_value: {
      get () {
  ...
  methods: {
    ...
    formSubmitted() {
      const obj = {
        ...
        state: this.state,
        value: this.value,
        ug_address: this.ug_address,
        ug_zipcode: this.ug_zipcode,
        ug_city: this.ug_city,
        ug_state: this.ug_state,
      }
      axios
        .post('http://localhost:8000/house', obj)
        .then(response => {
